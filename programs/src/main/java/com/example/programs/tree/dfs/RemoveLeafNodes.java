...
public class RemoveLeafNodes {
    public static void main(String[] args) {
       TreeNode.printPreorder(new RemoveLeafNodes().removeLeafNodes(Utils.arrayToTree(new Integer[]{1,2,3,2,null,2,4}),2));
    }
    ...
    class State {
        ...
        public State(TreeNode currentNode, TreeNode parentNode) {
